...
public class NavDrawerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,false,
            ...
            public void onDrawerClosed(View view) {
                getActionBar().setTitle(Html.fromHtml("<bold>"+mTitle+"</bold>"));
                // calling onPrepareOptionsMenu() to show action bar icons
                invalidateOptionsMenu();
            }

            public void onDrawerOpened(View drawerView) {
                getActionBar().setTitle(Html.fromHtml("<bold>"+mDrawerTitle+"</bold>"));
    ...
    class RegTask extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... params) {
            Intent intent = new Intent(NavDrawerActivity.this,GCMRegisterActivity.class);
